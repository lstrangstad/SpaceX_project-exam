...
function nextLaunchInfo(json) {
  ...
  <div class="countdown">
    ...
    if (difference < 0) {
      ...
      document.querySelector(".count").innerHTML = "TO BE ANNOUNCED";
    }
  }, 1000);
  ...
  <div class="txt-content">
    ...
    <p class="fact">${json.mission_name}</p>
    <p class="headers">Launch date local</p>
    <p class="fact">${json.launch_date_local}</p> 
...
function lastLaunchInfo(data) {
  ...
  <div class="txt-content">
    <p class="headers">Mission name</p>
    <p class="fact">${data.mission_name}</p>
    <p class="headers">Launch date local</p>
